    ...
    <div style={{ 
      ...
      >
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <p style={{ color: 'var(--text-dim)', fontSize: '0.9rem' }}>Sign in to track your career progress</p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          <div style={{ marginBottom: '1.25rem' }}>
            <label style={{ display: 'block', fontSize: '0.8rem', color: 'var(--text-dim)', marginBottom: '0.5rem' }}>Username or Email</label>
